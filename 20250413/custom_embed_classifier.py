...
def convert_text_to_tensor(texts, labels, word_to_idx):
    # 将文本转换为索引序列
    texts_idx = []
    for text in texts:
...
if __name__ == '__main__':
    ...
    labels = [1, 0, 1, 0]
    # 构建词典
    word_to_idx = build_vocab(texts, labels)
    # 将文本转换为索引序列
    texts_idx, label_tensor = convert_text_to_tensor(texts, labels, word_to_idx)
